...
console.log("MD (default): ", JSON.stringify(md1));
...
turndownService2.addRule('emptyParagraph', {
      filter: function (node) {
        return node.nodeName === 'P' && node.innerHTML.trim() === '<br><span id="caret-marker">\u200B</span>';
      },
